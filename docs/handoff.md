...
> 갱신: 2026-08-07T04:40Z (배포 마감 팔로업 세션). 이 파일은 매 TL 세션 마감 시 덮어쓴다.

## 보드

- completed 138건(전 작업) / qa_waiting 0 / in_progress 0 / todo 0 / blocked 0.
- QA 도장 4건(TASK-139·140·141·142)은 2026-08-07 사용자가 직접 확인 완료(QA-9CB7026D).
- v0.1.10 게시 완료(2026-08-07T04:19Z) — 리눅스 재실행 그린, 자산 14종·latest.json 확인 후 draft 해제.
